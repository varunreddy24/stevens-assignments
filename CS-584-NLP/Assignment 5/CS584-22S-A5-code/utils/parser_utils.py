...
class Parser(object):
    ...
    def __init__(self, dataset, minibatch_parse):
        ...
        self.minibatch_parse = minibatch_parse
    ...
    def parse(self, dataset, eval_batch_size=5000):
        ...
        dependencies = self.minibatch_parse(sentences, model, eval_batch_size)
...
def load_and_preprocess_data(minibatch_parse, reduced=True):
    config = Config()
    ...
    start = time.time()
    parser = Parser(train_set, minibatch_parse)
    print("took {:.2f} seconds".format(time.time() - start))
